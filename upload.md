...
<style>
    /* ── Full-screen overlay with blurred dark bg ── */
    #upload-screen {
        position: fixed;
        inset: 0;
        display: flex;
    ...
    /* ── File drop zone ── */
    #drop-zone {
        border: 2px dashed rgba(102,252,241,0.35);
        border-radius: 16px;
        padding: 32px 20px;
        margin-bottom: 18px;
        cursor: pointer;
    ...
    #drop-zone .dz-label { color: rgba(255,255,255,0.6); font-size: 0.95rem; line-height: 1.5; }
    ...
    .file-row .fstatus { flex-shrink: 0; font-size: 1rem; }
    ...
    <div class="upload-card" id="main-screen">
        ...
        <div id="drop-zone" onclick="document.getElementById('file-input').click()"
            ...
            <div class="dz-label">
                ...
                <span style="font-size:0.8rem;opacity:0.6">JPG, PNG, HEIC · multiple OK</span>
            </div>
        </div>
...
<script>
    ...
    function setFileStatus(index, icon) {
        var el = document.getElementById('fstatus-' + index);
